 ...
 **WHAT YOU KNOW**
 ...
 - **internships**:
    ...
    - **3tenets consulting** (jan 2025 – present): full stack developer in oakville, on.
        ...
        - also building a cool social engineering tool with twilio, gpt-4o, and elevenlabs to simulate ai phishing calls.
    ...
    - **petmap – uc berkeley startup** (jan 2025 – mar 2025): software engineer (remote from waterloo).
        - developed their registration flow with react and typescript, turning figma designs into real components.
        - used firebase cloud functions to sync user data with firestore.
        - built a map interface with mapbox api for dog owners to connect.
